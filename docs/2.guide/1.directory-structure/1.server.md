...
::warning
You must restart the development server after adding a new file for a target method. Otherwise, TypeScript will display an error message such as ts2322, as the target file has not yet been rendered at this point.
::
